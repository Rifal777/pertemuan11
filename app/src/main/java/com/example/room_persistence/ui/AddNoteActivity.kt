    ...
    private fun saveNote(){
        ...
        CoroutineScope(Dispatchers.IO).launch{
            try {
                ...
                runOnUiThread{
                    Toast.makeText(this@AddNoteActivity,"note save succes", Toast.LENGTH_SHORT).show()
                    finish()
        ...
        if (title.isEmpty()|| content.isEmpty()){
            Toast.makeText(this,"title and content cannot empty", Toast.LENGTH_SHORT).show()
            return
        }
